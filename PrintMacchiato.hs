...
instance Print Stmt where
  prt i e = case e of
    ...
    FunLoc type_ id args stmt -> prPrec i 0 (concatD [prt 0 type_, prt 0 id, doc (showString "("), prt 0 args, doc (showString ")"), prt 0 stmt])
    ...
    ArrAss id expr1 expr2 -> prPrec i 0 (concatD [prt 0 id, doc (showString "["), prt 0 expr1, doc (showString "]"), doc (showString "="), prt 0 expr2, doc (showString ";")])
    MapAss id expr1 expr2 -> prPrec i 0 (concatD [prt 0 id, doc (showString "[["), prt 0 expr1, doc (showString "]]"), doc (showString "="), prt 0 expr2, doc (showString ";")])
    ...
    ForUp id expr1 expr2 stmt -> prPrec i 0 (concatD [doc (showString "for"), prt 0 id, doc (showString "="), prt 0 expr1, doc (showString "to"), prt 0 expr2, doc (showString "do"), prt 0 stmt])
    ForDown id expr1 expr2 stmt -> prPrec i 0 (concatD [doc (showString "for"), prt 0 id, doc (showString "="), prt 0 expr1, doc (showString "downto"), prt 0 expr2, doc (showString "do"), prt 0 stmt])
...
instance Print Type where
  prt i e = case e of
    ...
    Tup types -> prPrec i 0 (concatD [doc (showString "<"), prt 0 types, doc (showString ">")])
    Arr type_ -> prPrec i 0 (concatD [prt 0 type_, doc (showString "[]")])
    Map type_1 type_2 -> prPrec i 0 (concatD [prt 0 type_1, doc (showString "[["), prt 0 type_2, doc (showString "]]")])
...
instance Print Expr where
  prt i e = case e of
    ...
    EAccMap id expr -> prPrec i 6 (concatD [prt 0 id, doc (showString "[["), prt 0 expr, doc (showString "]]")])
    EHasMap id expr -> prPrec i 6 (concatD [doc (showString "has"), prt 0 id, doc (showString "[["), prt 0 expr, doc (showString "]]")])
    EDelMap id expr -> prPrec i 6 (concatD [doc (showString "del"), prt 0 id, doc (showString "[["), prt 0 expr, doc (showString "]]")])
